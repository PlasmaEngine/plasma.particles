...
{
  m_pOwnApplication = PL_DEFAULT_NEW(plGameEngineTestApplication_Particles);
...
{
  PL_SUCCEED_OR_RETURN(SUPER::InitializeSubTest(iIdentifier));
  ...
  {
    m_pOwnApplication->SetupSceneSubTest("Particles/AssetCache/Common/Billboards.plBinScene");
    return PL_SUCCESS;
  }
  else if (iIdentifier == SubTests::PullAlongBehavior)
  {
    m_pOwnApplication->SetupSceneSubTest("Particles/AssetCache/Common/PullAlong.plBinScene");
    return PL_SUCCESS;
  }
  else if (iIdentifier == SubTests::DistanceEmitter)
  {
    m_pOwnApplication->SetupSceneSubTest("Particles/AssetCache/Common/DistanceEmitter.plBinScene");
    return PL_SUCCESS;
  }
  else if (iIdentifier == SubTests::SharedInstances)
  {
    m_pOwnApplication->SetupSceneSubTest("Particles/AssetCache/Common/SharedInstances.plBinScene");
    return PL_SUCCESS;
  }
  else if (iIdentifier == SubTests::EventReactionEffect)
  {
    m_pOwnApplication->SetupSceneSubTest("Particles/AssetCache/Common/EventReactionEffect.plBinScene");
    return PL_SUCCESS;
  }
  else if (iIdentifier == SubTests::LocalSpaceSim)
  {
    m_pOwnApplication->SetupSceneSubTest("Particles/AssetCache/Common/LocalSpaceSim.plBinScene");
    return PL_SUCCESS;
  }
  else if (iIdentifier == SubTests::Lighting)
  {
    m_pOwnApplication->SetupSceneSubTest("Particles/AssetCache/Common/Lighting.plBinScene");
    return PL_SUCCESS;
  }
  else
  {
...
{
  LoadScene("Particles/AssetCache/Common/Particles1.plBinScene").IgnoreResult();
...
plTestAppRun plGameEngineTestApplication_Particles::ExecParticleSubTest(plInt32 iCurFrame)
{
  ...
  {
    case 15:
      PL_TEST_IMAGE(0, m_uiImageCompareThreshold);
      break;

    case 30:
      PL_TEST_IMAGE(1, m_uiImageCompareThreshold);
      break;

    case 60:
      PL_TEST_IMAGE(2, m_uiImageCompareThreshold);
      return plTestAppRun::Quit;
  }
