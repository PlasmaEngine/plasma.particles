...
protected:
  ...
  void CreateParticleDataBuffer(plGALBufferPool& inout_Buffer, plUInt32 uiDataTypeSize, plUInt32 uiNumParticlesPerBatch);
  void DestroyParticleDataBuffer(plGALBufferPool& inout_Buffer);
