...
public:
  ...
  const plHybridArray<plParticleInitializerFactory*, 8>& GetInitializerFactories() const { return m_InitializerFactories; }
  ...
  const plHybridArray<plParticleBehaviorFactory*, 8>& GetBehaviorFactories() const { return m_BehaviorFactories; }
  ...
  const plHybridArray<plParticleTypeFactory*, 4>& GetTypeFactories() const { return m_TypeFactories; }
...
private:
  ...
  plHybridArray<plParticleTypeFactory*, 4> m_TypeFactories;
};
