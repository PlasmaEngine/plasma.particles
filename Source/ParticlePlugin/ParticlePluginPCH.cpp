...
// PL_BEGIN_STATIC_REFLECTED_ENUM(plCurveSource, 1)
//   PL_ENUM_CONSTANT(plCurveSource::CustomCurve),
//   PL_ENUM_CONSTANT(plCurveSource::SharedCurve),
// PL_END_STATIC_REFLECTED_ENUM;
//
// //////////////////////////////////////////////////////////////////////////
//
// PL_BEGIN_STATIC_REFLECTED_ENUM(plGradientSource, 1)
//   PL_ENUM_CONSTANT(plGradientSource::CustomGradient),
//   PL_ENUM_CONSTANT(plGradientSource::SharedGradient),
// PL_END_STATIC_REFLECTED_ENUM;
...
PL_BEGIN_STATIC_REFLECTED_ENUM(plGPUParticleRenderType, 1)
  PL_ENUM_CONSTANT(plGPUParticleRenderType::Billboard),
  PL_ENUM_CONSTANT(plGPUParticleRenderType::Point),
  PL_ENUM_CONSTANT(plGPUParticleRenderType::VelocityAligned),
  PL_ENUM_CONSTANT(plGPUParticleRenderType::Trail),
PL_END_STATIC_REFLECTED_ENUM;
...
PL_STATICLINK_LIBRARY(ParticlePlugin)
{
  ...
  PL_STATICLINK_REFERENCE(ParticlePlugin_Behavior_ParticleBehavior_AttractToPosition);
  ...
  PL_STATICLINK_REFERENCE(ParticlePlugin_Behavior_ParticleBehavior_If);
  PL_STATICLINK_REFERENCE(ParticlePlugin_Behavior_ParticleBehavior_NoiseForce);
  PL_STATICLINK_REFERENCE(ParticlePlugin_Behavior_ParticleBehavior_Opacity);
