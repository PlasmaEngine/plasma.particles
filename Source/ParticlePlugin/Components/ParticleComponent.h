...
public:
  ...
  void OnMsgInterruptPlaying(plMsgInterruptPlaying& ref_msg); // [ msg handler ]
  ...
  void SetParticleEffectFile(plStringView sFile); // [ property ]
  plStringView GetParticleEffectFile() const;     // [ property ]
