...
plUInt32 plParticleType::ComputeSortingKey(plParticleTypeRenderMode::Enum mode, plUInt64 uiResource1Hash, plUInt64 uiResource2Hash)
{
  plUInt32 key = 0;
  ...
  key |= plHashingUtils::StringHashTo32(uiResource1Hash) & 0x1FFFFFFFu;
  key |= plHashingUtils::StringHashTo32(uiResource2Hash) & 0x1FFFFFFFu;
