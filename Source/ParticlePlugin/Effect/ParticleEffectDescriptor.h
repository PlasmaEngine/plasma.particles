...
public:
  ...
  const plHybridArray<plParticleSystemDescriptor*, 8>& GetParticleSystems() const { return m_ParticleSystems; }
...
private:
  plHybridArray<plParticleSystemDescriptor*, 8> m_ParticleSystems;
